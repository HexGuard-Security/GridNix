...
{
  # Home Manager configuration for the GridNix user
  ...
  programs.zsh = {
    ...
    initExtra = ''
      # Custom GridNix prompt
      PROMPT="%F{red}[GridNix]%f %F{blue}%n@%m%f:%F{green}%~%f$ "
  ...
  programs.git = {
    enable = true;
    userName = "GridNix User";
    userEmail = "user@GridNix.org";
    extraConfig = {
      core.editor = "nvim";
      color.ui = true;
      pull.rebase = false;
