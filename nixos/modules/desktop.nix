...
{
  # Desktop environment configuration for GridNix
        ...
        <property name="backdrop" type="empty">
          <property name="screen0" type="empty">
            <property name="monitor0" type="empty">
              <property name="image-path" type="string">/etc/nixos/wallpapers/GridNix-wallpaper.png</property>
              <property name="last-image" type="string">/etc/nixos/wallpapers/GridNix-wallpaper.png</property>
              <property name="last-single-image" type="string">/etc/nixos/wallpapers/GridNix-wallpaper.png</property>
