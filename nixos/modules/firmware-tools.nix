...

{
  ...
  system.activationScripts.firmwareDir = ''
    ...
    chown GridNix:users /opt/firmware
  '';
  
  # Create workshop directory structure for firmware analysis
  system.activationScripts.firmwareWorkshop = ''
    mkdir -p /home/GridNix/firmware-workshop/{extracted,workbench,tools,reports}
    chown -R GridNix:users /home/GridNix/firmware-workshop
  '';
  ...
  security.pam.loginLimits = [
    { domain = "GridNix"; type = "-"; item = "memlock"; value = "unlimited"; }
    { domain = "GridNix"; type = "-"; item = "nofile"; value = "65536"; }
  ];
}
