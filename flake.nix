{ 
  description = "GridNix: A NixOS-based OS for IoT penetration testing and hardware hacking";
  ...
  outputs = { self, nixpkgs, nixos-hardware, home-manager, nixos-generators, ... }@inputs:
    ...
    in {
      nixosConfigurations = {
        GridNix = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules = [
            ...
            home-manager.nixosModules.home-manager
            {
              ...
              home-manager.users.GridNix = import ./nixos/home/GridNix.nix;
            }
          ];
